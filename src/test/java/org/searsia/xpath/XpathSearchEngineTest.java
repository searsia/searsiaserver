...
public class XpathSearchEngineTest {

	private static final String SECRET_API_KEY = "a7235cdsf43d3a2dfgeda";
	
	private XpathSearchEngine hiemstraSearch() throws XPathExpressionException {
		XpathSearchEngine hiemstra = new XpathSearchEngine("hiemstra", "Djoerd Hiemstra");
	...
	private XpathSearchEngine searsiaSearch() throws XPathExpressionException {
		return new XpathSearchEngine("http://search.utwente.nl/searsia/search.php?q={q?}&r={r?}");
	}
	...
	public void testSearch1() throws XPathExpressionException, SearchException {
		XpathSearchEngine se = hiemstraSearch();
	...
	public void testSearch2() throws XPathExpressionException, SearchException {
		XpathSearchEngine se = searsiaSearch();
	...
	public void testSearchResource() throws XPathExpressionException, SearchException {
		XpathSearchEngine se = searsiaSearch();
		XpathSearchEngine engine = se.searchResource("utnieuws");
	...
	public void testJsonRoundtrip() throws XPathExpressionException {
		XpathSearchEngine se1 = hiemstraSearch();
		se1.setPostString("POST");
		se1.setBanner("me.png");
		JSONObject json = se1.toJson();
		XpathSearchEngine se2 = new XpathSearchEngine(json);
	...
	public void equalEngines2() throws XPathExpressionException {
		XpathSearchEngine se1 = searsiaSearch();
		JSONObject json = se1.toJson();
		XpathSearchEngine se2 = new XpathSearchEngine(json);
